...
export default class App extends Component {
  ...
  onButtonSubmit = () => {
    ...
    this.state.todos.length >= 12
      ? alert("Too many todos (Limit: 12)")
      : this.state.input === ""
        ? alert("Empty input")
  ...
  onKeyPress = event => {
    event.charCode === 13
      ? document
          .getElementById("todos-append")
          .click() /*Using onButtonSubmit as callback function*/
      : false;
  };
    ...
    return (
      <div className="container">
        <InputBox
          ...
          removeTodos={this.removeSelected}
        />
        <ul>
